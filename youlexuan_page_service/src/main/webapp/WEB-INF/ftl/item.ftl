							...
							<dl>
								...
								<#list entity.attributeValue as option>
										<dd><a href="javascript:;"
                                               ng-click="selectSpecification('${entity.attributeName}','${option}')"
                                               class="{{ isSelected('${entity.attributeName}','${option}')?'selected':''}}">
											${option}
                                            <span title="点击取消选择">&nbsp;
												</span>
                                        </a>
                            ...
                            <ul class="goods-list unstyled">
                                <li>
                                    <div class="list-wrap">
                                        ...
                                        <div class="operate">
                                            <a href="javascript:void(0);" class="sui-btn btn-bordered" ng-click="addToCart()">加入购物车</a>
                                        </div>
                                    </div>
                                </li>
                                <li>
